...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto d9f49deb28b146c0a6be846898701e64 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot pll xil_defaultlib.pll xil_defaultlib.glbl -log elaborate.log
}
